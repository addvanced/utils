...
// It takes an integer value of bytes and return a float64 value of megabytes
...
func MinutesToHours(m int64) float64 {
	return float64(m) / SecondsPerMinute
}
...
func CelsiusToFahrenheit(c float64) float64 {
	return roundToTwoDecimals((c * CelsiusToFahrenheitFactor) + CelsiusFahrenheitOffset)
}

// FahrenheitToCelsius converts Fahrenheit to Celsius.
// It takes a float64 value of Fahrenheit and returns the equivalent in Celsius as a float64.
func FahrenheitToCelsius(f float64) float64 {
	return roundToTwoDecimals((f - CelsiusFahrenheitOffset) * FahrenheitToCelsiusFactor)
}
...
func CelsiusToKelvin(c float64) float64 {
	return roundToTwoDecimals(c + CelsiusToKelvinOffset)
}
...
func KelvinToCelsius(k float64) float64 {
	return roundToTwoDecimals(k - CelsiusToKelvinOffset)
}
...
func FahrenheitToKelvin(f float64) float64 {
	return roundToTwoDecimals((f + FahrenheitToKelvinOffset) * FahrenheitToCelsiusFactor)
}
...
func KelvinToFahrenheit(k float64) float64 {
	return roundToTwoDecimals((k-CelsiusToKelvinOffset)*CelsiusToFahrenheitFactor + CelsiusFahrenheitOffset)
}
